...
@interface GBShopcartBottomView ()
...
@implementation GBShopcartBottomView
...
//         _allSelectButton.backgroundColor=[UIColor redColor];
    }
...
//        _totalPriceLable.backgroundColor=[UIColor cyanColor];
...
- (void)layoutSubviews {
    ...
    [self.totalPriceLable mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.bottom.equalTo(self);
        make.left.equalTo(self.allSelectButton.mas_right).offset(20);
